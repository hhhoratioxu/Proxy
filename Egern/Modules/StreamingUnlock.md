...
当前版本已改为 **Liquid Glass** 视觉，同时保留原有严格解锁检测逻辑。

Egern Widget DSL 目前公开支持透明/半透明颜色、渐变、描边和阴影，但没有公开的系统级 `blur/material` 属性，所以这一版是在 Egern 原生 DSL 能力范围内，用以下方式模拟 Liquid Glass：
